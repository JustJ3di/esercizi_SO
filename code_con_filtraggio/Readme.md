Si realizzi in linguaggio C/C++ un'applicazione multiprocesso basata su code di messaggi UNIX, secondo lo schema in pipeline illustrato di seguito e in figura.
